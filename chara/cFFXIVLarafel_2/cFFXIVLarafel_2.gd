...
func _extInit():
	...
	addSkillTxt("""[星极火]：被动，[爆炎]释放后，后续的[爆炎]伤害增加30%，延长[玄冰]的ÇÐ
[灵极冰]：被动，使用[玄冰]后降低[爆炎]的ÇÐ三次，重置[爆炎]的伤害提升阶段""")
	addSkillTxt("""[爆炎]：ÇÐ26s，对目标造成[240%]的魔法伤害
[玄冰]：ÇÐ6s，对目标及周围一格的敌人造成[100%]的魔法伤害""")
