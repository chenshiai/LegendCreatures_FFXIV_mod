...
func _extInit():
	...
	chaName = "欧米茄F"
	lv = 4
	addSkillTxt("""[太阳射线]：死刑，对当前攻击目标造成[未知]法强的小范围魔法伤害
[激光雨]：对全屏的敌人造成[未知]法强的魔法伤害
[优化爆炎]：对所有敌人造成一次[未知]法强的小范围魔法伤害""")
	addSkillTxt("""[宇宙之光]：战斗时间超过 %ds 后，进入狂暴，每5s释放一次激光雨，每次伤害增加30%
...
func _onBattleStart():
	._onBattleStart()
	solaRays_pw = 4 * (E_lv / E_num)
	laserRain_pw = 0.75 * (E_lv / E_num)
	optimizedFireIII_pw = 1 * (E_lv / E_num)
...
func _onBattleEnd():
	._onBattleEnd()
	skillStrs[1] = """[太阳射线]：死刑，对当前攻击目标造成[未知]法强的小范围魔法伤害
[激光雨]：对全屏的敌人造成[未知]法强的魔法伤害
[优化爆炎]：对所有敌人造成一次[未知]法强的小范围魔法伤害"""
