...
【上下左右】所有单位向特定方向移动一格。快捷键[color=#9cff7d]【W/A/S/D】[/color]
【分散】所有单位分散至场边，且互不相邻。快捷键[color=#9cff7d]【R】[/color]
【平行】所有单位移动至场地上下两边。快捷键[color=#9cff7d]【T】[/color]
【左/右集】所有单位在场地的 [左/右] 边集合。快捷键[color=#9cff7d]【Q/E】[/color]

【退避】优先选择己方场上防御能力最高的角色，使其吸引所有敌人的仇恨，不会被连续集火两次。快捷键[color=#9cff7d]【V】[/color]
