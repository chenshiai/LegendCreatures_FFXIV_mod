...
【上下左右】[/b]所有单位向特定方向移动一格。快捷键[color=#9cff7d]【W/A/S/D】[/color]
【分散】[/b]所有单位分散至场边，且互不相邻。快捷键[color=#9cff7d]【R】[/color]
【平行】[/b]所有单位移动至场地上下两边。快捷键[color=#9cff7d]【T】[/color]
【左/右集】[/b]所有单位在场地的 [左/右] 边集合。快捷键[color=#9cff7d]【Q/E】[/color]

【退避】[/b]优先选择己方场上防御能力最高的角色，使其吸引所有敌人的仇恨，不会被连续集火两次。快捷键[color=#9cff7d]【V】[/color]

[color=#ff7e7e]※使用极限技会消耗全部极限技槽[/color]
极限技效果会根据极限槽等级来提升，仅讨伐战、歼灭战有效。
【防护】短时间内给队友减伤，减伤[20%/40%/80%]。快捷键[color=#9cff7d]【C】[/color]
【进攻】对敌方单体造成极大伤害，全队攻击总和[1倍/2倍/3倍]的真实伤害。快捷键[color=#9cff7d]【X】[/color]
【治疗】为友方单位恢复最大生命的[30%/60%/100%]，三级时附加复活效果。快捷键[color=#9cff7d]【Z】[/color]"""
} 
