...
var UpdateInfo = {
	"title": "最终幻想14-更新记录",
	"content": format("""[color=#64a6b7]【Ver 2.7.2】2020-07-03[/color]
这几天对代码进行了绝赞优化~~~
...
[血壤] 移除
[续剑] 攻速增加 20% -> 50%，新增：普通攻击附带35%攻击力的魔法伤害
[超火流星] 玩家方发动几率为100%，电脑方发动几率为40%
[爆破领域] 冷却时间 15s -> 10s

{c_atk}【忍者】{/c}{c_pas}给远程忍者的福利，功能性大大加强{/c}
[冰遁之术][火遁之术] “对自身周围两格内的敌人释放” 改为 “对目标以及周围两格内的敌人释放”
[强甲破点突] 现在战斗开始时就可以释放一次
...
{c_tre}【占星术士-昼】{/c}{c_pas}请专注卡牌分类{/c}
[阳星相位] 持续恢复效果治疗系数 15% -> 10%，持续时间 8s -> 5s
